...
<div id="classy-error" class="content">
  ...
  <div class="errorpage-message sr-description">
      <h2>${_("a message from the moderators of /%s/%s") % (g.brander_community_abbr, c.site.name)}</h2>
  ...
  <div id="private-subreddit-message-link" class="errorpage-message">
    <a href="/message/compose/?to=/${g.brander_community_abbr}/${c.site.name}">${_("send a message to the moderators")}</a>
  </div>
  % endif
</div>
