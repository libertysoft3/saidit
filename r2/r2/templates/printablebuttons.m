...
<%namespace file="utils.m" import="plain_link, pretty_button, data, error_field" />
...
<%def name="linkbuttons()">
  ...
  % if thing.show_chat_link:
    <li class="chat-popout">
      <a target="_blank" href="${thing.chat_popout_url}">${_("open chat in new tab")}</a>
    </li>
  %endif
