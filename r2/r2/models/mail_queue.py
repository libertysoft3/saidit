...
class Email(object):
    ...
    subjects = {
        Kind.SHARE : "[" + g.brander_site + "] " + _("%(user)s has shared a link with you"),
        Kind.FEEDBACK : _("[feedback] feedback from '%(user)s'"),
        Kind.ADVERTISE :  _("[advertising] feedback from '%(user)s'"),
        Kind.OPTOUT : "[" + g.brander_site + "] " + _("email removal notice"),
        Kind.OPTIN  : "[" + g.brander_site + "] " + _("email addition notice"),
        Kind.RESET_PASSWORD : "[" + g.brander_site + "] " + _("reset your password"),
        Kind.VERIFY_EMAIL : "[" + g.brander_site + "] " + _("verify your email address"),
        Kind.BID_PROMO : "[" + g.brander_site + "] " + _("your budget has been accepted"),
        Kind.ACCEPT_PROMO : "[" + g.brander_site + "] " + _("your promotion has been accepted"),
        Kind.REJECT_PROMO : "[" + g.brander_site + "] " + _("your promotion has been rejected"),
        Kind.QUEUED_PROMO : "[" + g.brander_site + "] " + _("your promotion has been charged"),
        Kind.LIVE_PROMO   : "[" + g.brander_site + "] " + _("your promotion is now live"),
        Kind.FINISHED_PROMO : "[" + g.brander_site + "] " + _("your promotion has finished"),
        Kind.NEW_PROMO : "[" + g.brander_site + "] " + _("your promotion has been created"),
        Kind.EDITED_LIVE_PROMO : "[" + g.brander_site + "] " + _("your promotion edit is being approved"),
        Kind.NERDMAIL : "[" + g.brander_site + "] " + _("hey, nerd!"),
        Kind.GOLDMAIL : "[" + g.brander_site + "] " + _("reddit gold activation link"),
        Kind.PASSWORD_CHANGE : "[" + g.brander_site + "] " + _("your password has been changed"),
        Kind.EMAIL_CHANGE : "[" + g.brander_site + "] " + _("your email address has been changed"),
        Kind.REFUNDED_PROMO: "[" + g.brander_site + "] " + _("your campaign didn't get enough impressions"),
        Kind.VOID_PAYMENT: "[" + g.brander_site + "] " + _("your payment has been voided"),
        Kind.GOLD_GIFT_CODE: "[" + g.brander_site + "] " + _("your reddit gold gift code"),
        Kind.SUSPICIOUS_PAYMENT: "[" + g.brander_site + "] " + _("[selfserve] suspicious payment alert"),
        Kind.FRAUD_ALERT: "[" + g.brander_site + "] " + _("[selfserve] fraud alert"),
        Kind.USER_FRAUD: "[" + g.brander_site + "] " + _("[selfserve] a user has committed fraud"),
        Kind.MESSAGE_NOTIFICATION: "[" + g.brander_site + "] " + _("message notification"),
        Kind.ADS_ALERT: "[" + g.brander_site + "] " + _("Ads Alert"),
        }
